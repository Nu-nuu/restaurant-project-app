...
public class CardFoodAdapter extends RecyclerView.Adapter<CardFoodAdapter.CardFoodViewHolder> {

    private List<Fooded> foodList;
    private Context context;

    public CardFoodAdapter(List<Fooded> foodList, Context context) {
